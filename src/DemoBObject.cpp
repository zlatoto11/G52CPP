...
DemoBObject::DemoBObject(BaseEngine* pEngine) : DisplayableObject ( pEngine)
{
...
void DemoBObject::DoUpdate(int iCurrentTime)  //update currentscreen X + Y variables, and change where objects are drawn
{
